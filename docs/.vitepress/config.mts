...
export default withMermaid({
  ...
  base: "/chain-of-custody-zome",
  title: "Chain Of Custody Zome",
  description: "Chain Of Custody zome for holochain apps",
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/darksoil-studio/chain-of-custody-zome",
      },
    ],
    search: {
      provider: 'local'
