import{t as ye,d as $e,f as we,i as xe,j as Ie,v as je,u as Se,o as ae,M as Fe,m as He,h as Ue,e as ze,g as We,a as Xe,b as _e,s as qe}from"./api-viewer-tabs.Do-u8Han.js";import{_ as S}from"./tslib.es6.kHcLnhpD.js";import{i as ce}from"./reactive-element.ChgaCBqn.js";import{e as ue,i as pe,D as Ve,A as de,x,t as Ne,T as Re,n as N,s as Pe}from"./property.BxkfmjrS.js";const Y=[],Ze=(n,e)=>{Y[n]=e},I=Object.freeze({HOST:"host",KNOB:"knob",SLOT:"slot",PREFIX:"prefix",SUFFIX:"suffix",WRAPPER:"wrapper"}),B=n=>n instanceof HTMLTemplateElement,fe=(n,e)=>t=>{const{element:s,target:r}=t.dataset;return s===n&&r===e},J=n=>B(n)?n.content.firstElementChild:null,W=(n,e,t)=>Y[n].find(fe(e,t)),Ge=(n,e,t)=>Y[n].filter(fe(e,t)),re=(n,e,t)=>Y[n].some(fe(e,t));/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ee=n=>je(n)?n._$litType$.h:n.strings,Je=ue(class extends pe{constructor(n){super(n),this.tt=new WeakMap}render(n){return[n]}update(n,[e]){const t=ye(this.et)?Ee(this.et):null,s=ye(e)?Ee(e):null;if(t!==null&&(s===null||t!==s)){const r=$e(n).pop();let a=this.tt.get(t);if(a===void 0){const i=document.createDocumentFragment();a=Ve(de,i),a.setConnected(!1),this.tt.set(t,a)}we(a,[r]),xe(a,void 0,r)}if(s!==null){if(t===null||t!==s){const r=this.tt.get(s);if(r!==void 0){const a=$e(r).pop();Ie(n),xe(n,void 0,a),we(n,[a])}}this.et=e}else this.et=void 0;return this.render(e)}});class he{get data(){return this._data}set data(e){this._data=e,this.updateData(e)}updateData(e){this.host.isConnected&&this.host.requestUpdate()}constructor(e,t){this._data=[],(this.host=e).addController(this),this.el=t}clear(){this.data=[]}destroy(){this.host.removeController(this)}}class Qe extends he{constructor(e,t,s){super(e,t),s.forEach(({name:r})=>{t.addEventListener(r,a=>{const i="-changed";if(r.endsWith(i)){const{knob:o}=e.getKnob(r.replace(i,""));e.syncKnob(t,o)}this.data=[...this.data,a]})})}}const Ye=n=>n[0].toUpperCase()+n.slice(1),Le=n=>Ye(n===""?"content":n),et=(n,e)=>{const{name:t,value:s}=n;return x`
    <input
      id=${e}
      type="text"
      .value=${String(s)}
  ...
  ${n.map(e=>x`
      <p part="event-record">
        event:
        ${e.type}.${e.detail==null?de:at(e.detail)}
      </p>
    `)}
 ...
 */const Ce=ue(class extends pe{constructor(n){if(super(n),n.type!==Ne.CHILD)throw Error("templateContent can only be used in child bindings")}render(n){return this.vt===n?Re:(this.vt=n,document.importNode(n.content,!0))}}),{HOST:Mt,PREFIX:It,SLOT:jt,SUFFIX:Ft,WRAPPER:Ht}=I,Ut=(n,e)=>{const{knobs:t}=e;Object.keys(t).forEach(s=>{const{attribute:r,value:a,custom:i}=t[s];i&&r?typeof a=="string"&&a?n.setAttribute(r,a):n.removeAttribute(r):n[s]=a})},Te=n=>typeof n=="object"&&Promise.resolve(n)===n;async function zt(n){let e=!1;const t=n,s=t.updateComplete;Te(s)&&(await s,e=!0);const r=t.componentOnReady?t.componentOnReady():!1;return Te(r)&&(await r,e=!0),e||await new Promise(requestAnimationFrame),t}class Wt extends pe{constructor(e){if(super(e),e.type!==Ne.CHILD)throw new Error("renderer only supports binding to element")}render(e){return de}update(e,[t]){var E;const s=(E=e.options)==null?void 0:E.host,{tag:r}=t,a=[],[i,o,u,v,h]=[Mt,It,Ft,jt,Ht].map(y=>W(t.id,r,y)),f=J(h),b=f?f.localName:"";let g=s.querySelector(r);if(g){const y=s.querySelector('[part="demo-output"]'),p=g.parentElement;if(p&&(p===y||p.localName===b))return Ut(g,t),Re}const k=`</${r}>`,d=J(i);B(o)&&a.push(Ce(o));let m=d?d.outerHTML:`<${r}>${k}`;if(B(v)&&(m=m.replace(k,`${v.innerHTML}${k}`)),b){const y=ae(`
    ...
    <api-demo-layout
      ...
      part="demo-container"
    ></api-demo-layout>
  `}let qt=0;class Me extends Fe(Pe){constructor(){super(),this._id=qt++}render(){return x`
      ${He(_t(this.jsonFetched,this._onSelect,this.only,this.selected,this._id,this.excludeKnobs))}
    `}_onSelect(e){this.selected=e.target.value}}S([N({type:String,attribute:"exclude-knobs"})],Me.prototype,"excludeKnobs",void 0);const Vt=ce`
  pre {
    margin: 0;
    color: black;
    background: none;
...
`,Gt=ce`
  ${Zt}
  ${Vt}
`;class Jt extends Me{static get styles(){return[qe,Gt]}firstUpdated(){this.setTemplates()}setTemplates(e){Ze(this._id,e||Array.from(this.querySelectorAll("template")))}}customElements.define("api-demo",Jt);export{Jt as ApiDemo};
